...
export const RELEASES_URL = 'https://api.github.com/repos/FryingGorilla/suspicious-stew/releases/latest';
export const IS_WINDOWS = process.platform === 'win32';
export const IS_IN_DEV = process.pkg === undefined && process.env.NODE_ENV !== 'production';
export const API_URL = (IS_IN_DEV && getArgValue('api', 'http://localhost:8080')) || 'https://stew-api.vercel.app';
...
[BASE_DIR, CONFIGS_DIR, CACHE_DIR, LOGS_DIR, ACCOUNTS_DIR, BIN_DIR].forEach((dir) => {
...
export const ACCOUNT_LIMIT_CACHE = (uuid: string) => path.join(ACCOUNT_CACHE_DIR(uuid), 'limits.json');
